      ...
      >
        ...
        >
          {kpiCards.map((c) => (
            ...
            >
              <div style={{ fontSize: 16, fontWeight: 700, color: "rgb(80,80,80)", letterSpacing: 0.5 }}>
                {c.label}
              </div>
              <div style={{ fontSize: 40, fontWeight: 900, color: c.color, marginTop: 6 }}>{c.value}</div>
            </div>
          ))}
        </div>
            ...
            <tbody>
              {report.industries.map((r, i) => (
                <tr key={i} style={{ borderBottom: "1px solid rgb(255,220,232)" }}>
                  <td style={{ padding: "16px 16px", fontWeight: 700 }}>{r.ten}</td>
                  <td style={{ padding: "16px 14px", textAlign: "center" }}>{fmt(r.sl, 0)}</td>
                  <td style={{ padding: "16px 14px", textAlign: "center", color: "rgb(28,60,140)", fontWeight: 700 }}>
                    {fmt(r.dtqd)}
                  </td>
                  <td style={{ padding: "16px 14px", textAlign: "center", color: "rgb(20,110,55)", fontWeight: 700 }}>
                    {fmt(r.lai_gop)}
                  </td>
                  <td
                    style={{
                  ...
                  <td style={{ padding: "16px 14px", textAlign: "center" }}>{fmt(r.don_gia)}</td>
                  <td
                    style={{
                      padding: "16px 14px",
                      textAlign: "center",
